...
describe('unique constraints in migration SQL', () => {
  it('teams migration contains UNIQUE constraint on (code, age_group)', () => {
    const sql = readMigration(
      '20260223180005_create_teams_table.sql',
    );
